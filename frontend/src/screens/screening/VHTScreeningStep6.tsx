      ...
      <ScrollView style={styles.content} contentContainerStyle={{ paddingBottom: 24 }} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          {explanationSteps.map((step) => (
            <TouchableOpacity
              key={step.id}
              style={[styles.explanationCard, demonstratedSteps.has(step.id) && styles.explanationCardDemonstrated]}
            ...
            >
              <View style={styles.cardLeft}>
                <View style={[styles.checkbox, demonstratedSteps.has(step.id) && styles.checkboxDemonstrated]}>
                  {demonstratedSteps.has(step.id) && <Ionicons name="checkmark" size={16} color="#FFF" />}
                </View>
                <View style={{ flex: 1 }}>
              ...
              <Ionicons name={step.icon as any} size={24} color={demonstratedSteps.has(step.id) ? "#8B5CF6" : "#D1D5DB"} />
            </TouchableOpacity>
          ))}
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.confirmationButtons}>
            ...
            >
              <Ionicons name={clientUnderstands === false ? "radio-button-on" : "radio-button-off"} size={20} color={clientUnderstands === false ? "#DC2626" : "#D1D5DB"} />
            ...
            >
              <Ionicons name={clientUnderstands === true ? "radio-button-on" : "radio-button-off"} size={20} color={clientUnderstands === true ? "#10B981" : "#D1D5DB"} />
