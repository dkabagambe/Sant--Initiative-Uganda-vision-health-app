...
const districtCounties: Record<string, string[]> = {
  ...
  Bugiri: [
    "Bukooli Central County",
    "Bukooli North County",
  ...
  Kazo: ["Kazo County"],
  Kibaale: [
    "Bugangaizi County East",
    "Bugangaizi County West",
    "Buyanja County",
  ],
...
const countySubCounties: Record<string, string[]> = {
  ...
  // Busia
  "Samia-Bugwe County North": [
    "Busia Municipality",
    "Bulumbi Sub-County",
    "Dabani Sub-County",
    "Masafu Sub-County",
  ],
  "Samia-Bugwe County South": [
    "Buteba Sub-County",
    "Lunyo Sub-County",
    "Majanji Sub-County",
    "Lumino Sub-County",
  ...
  "Bunyole County West": [
    "Himutu Sub-County",
    "Kachonga Sub-County",
    "Nawanjofu Sub-County",
    "Naweyo Sub-County",
  ],
  // Butambala
  "Butambala County": [
    "Budde Sub-County",
    "Butambala Sub-County",
    "Gombe Sub-County",
    "Gombe Town Council",
    "Kalamba Sub-County",
    "Ngando Sub-County",
  ...
  "Kigulu County South": [
    "Bulamogi Sub-County",
    "Buyanga Sub-County",
    "Namungalwe Sub-County",
    "Nawandala Sub-County",
  ],
  // Isingiro
  "Bukanga County": [
    "Birere Sub-County",
  ...
  "Isingiro County North": [
    ...
    "Mbaare Sub-County",
    "Nyakitunda Sub-County",
  ],
  "Isingiro County South": [
    "Kabaare Sub-County",
    "Ngarama Sub-County",
    "Ngarama Town Council",
    "Rugaaga Sub-County",
  ],
  // Jinja
  "Butembe County": [
  ...
  "Kaberamaido County": [
    "Alwa Sub-County",
    "Kaberamaido Sub-County",
    "Kaberamaido Town Council",
    "Kalaki Sub-County",
    "Kobulubulu Sub-County",
    "Otuboi Sub-County",
    "Otuboi Town Council",
  ],
  // Kagadi
  ...
  "Bulamogi County": [
    "Bukamba Sub-County",
    "Bumanya Sub-County",
    "Bumanya Town Council",
    "Gadumire Sub-County",
    "Kaliro Sub-County",
    "Kaliro Town Council",
    "Namugongo Sub-County",
  ],
  "Bulamogi North County": [
    "Kisinda Sub-County",
    "Nawaikoke Sub-County",
  ...
  "Kinkizi County West": [
    "Butogota Town Council",
    "Kambuga Sub-County",
    "Kambuga Town Council",
    "Kihihi Sub-County",
    "Kihihi Town Council",
    "Nyamirama Sub-County",
  ],
  // Kapchorwa
  "Tingey County": [
  ...
  // Kasanda
  "Kasanda County North": [
    "Kasanda Sub-County",
    "Kasanda Town Council",
    "Kitumbi Sub-County",
    "Myanzi Sub-County",
  ],
  "Kasanda County South": [
    "Kalwana Sub-County",
    "Kiganda Sub-County",
    "Kiganda Town Council",
    "Sekanyonyi Sub-County",
  ],
  // Kasese
  "Bukonzo County East": [
    "Bwera Sub-County",
  ...
  "Nyabushozi County": [
    "Kakyera Sub-County",
    "Kanyaryeru Sub-County",
    "Kenshunga Sub-County",
    "Kikatsi Sub-County",
    "Kinoni Sub-County",
    "Kinoni Town Council",
    "Kiruhura Sub-County",
  ...
  "Bufumbira County East": [
    ...
    "Kisoro Municipality",
    "Muramba Sub-County",
    "Nyabwishenya Sub-County",
    "Nyakabande Sub-County",
  ],
  ...
  // Kitagwenda
  "Kitagwenda County": [
    "Kitagwenda Sub-County",
    "Kitagwenda Town Council",
    "Kicece Sub-County",
    "Mahyoro Sub-County",
    "Ntara Sub-County",
  ],
  ...
  "Chua County East": [
    "Kitgum Municipality",
    "Kitgum Matidi Sub-County",
    "Labongo-Akwang Sub-County",
    "Labongo-Amida Sub-County",
    "Mucwini Sub-County",
  ],
  "Chua County West": [
    "Labongo-Layamo Sub-County",
    "Lagoro Sub-County",
    "Namokora Sub-County",
    "Orom Sub-County",
  ],
  ...
  "Kyenjojo County": [
    ...
    "Kyarusozi Sub-County",
  ],
  "Mwenge County North": [
    "Butunduzi Sub-County",
    "Katoke Sub-County",
    "Kisojo Sub-County",
    "Nyankwanzi Sub-County",
  ],
  "Mwenge County South": [
    "Bufunjo Sub-County",
    "Bugaaki Sub-County",
  ...
  // Madi-Okollo
  "Madi-Okollo County": [
    "Madi-Okollo Sub-County",
    "Madi-Okollo Town Council",
    "Ogoko Sub-County",
    "Oluvu Sub-County",
  ],
  "Okollo County": [
  ...
  "Bukoto County East": [
    "Buwunga Sub-County",
    "Kabonera Sub-County",
    "Kimanya-Kabonera Division",
    "Masaka Municipality",
    "Nyendo-Senyange Division",
  ],
  "Bukoto County West": [
    "Bukakata Sub-County",
    "Kyannamukaaka Sub-County",
    "Mukungwe Sub-County",
  ],
  // Masindi
  "Bujenje County": [
  ...
  "Buruli County": [
    "Kimengo Sub-County",
    "Kinyara Sub-County",
    "Masindi Port Sub-County",
  ],
  // Mayuge
  "Bunya County East": [
    "Baitambogwe Sub-County",
    "Busakira Sub-County",
    "Imanyiro Sub-County",
    "Mayuge Sub-County",
    "Mayuge Town Council",
  ...
  "Bunya County South": [
    "Bukabooli Sub-County",
    "Buwaiswa Sub-County",
    "Jaguzi Sub-County",
    "Kityerera Sub-County",
    "Malongo Sub-County",
  ],
  "Bunya County West": [
  ...
  // Mitooma
  "Ruhinda County North": [
    "Kanyabwanga Sub-County",
    "Kashenshero Sub-County",
    "Mitooma Sub-County",
    "Mitooma Town Council",
  ],
  "Ruhinda County South": [
    "Bitereko Sub-County",
    "Kiyanga Sub-County",
    "Mutara Sub-County",
    "Rwashamaire Sub-County",
  ],
  // Mityana
  "Mityana County North": [
    ...
    "Namutamba Sub-County",
    "Ssekanyonyi Sub-County",
  ],
  "Mityana County South": [
    "Bulera Sub-County",
    "Kalangaalo Sub-County",
    "Maanyi Sub-County",
    "Zigoti Sub-County",
  ],
  // Moroto
  "Matheniko County": [
    "Katikekile Sub-County",
    "Moroto Municipality",
    "Nadunget Sub-County",
    "Rupa Sub-County",
    "Tapac Sub-County",
  ...
  "Nakaseke County South": [
    "Kasangombe Sub-County",
    "Kinoni Sub-County",
    "Wakyato Sub-County",
  ],
  // Nakasongola
  ...
  "Nakasongola County": [
    "Lwabyata Sub-County",
    "Nakasongola Sub-County",
    "Nakasongola Town Council",
    "Nakitoma Sub-County",
    "Nabiswera Sub-County",
  ],
  // Namayingo
  "Namayingo County North": [
    "Banda Sub-County",
    "Buyinja Sub-County",
    "Lolwe Sub-County",
    "Namayingo Sub-County",
    "Namayingo Town Council",
  ],
  "Namayingo County South": [
    "Buswale Sub-County",
    "Mutumba Sub-County",
    "Sigulu Sub-County",
  ],
  ...
  "Namisindwa County": [
    "Bukiabi Sub-County",
    "Bumbo Sub-County",
    "Lwakhakha Sub-County",
    "Lwakhakha Town Council",
    "Namisindwa Sub-County",
  ],
  "Bubulo East County": [
    "Magale Sub-County",
    "Namabya Sub-County",
  ...
  "Ruhaama County": [
    ...
    "Nyakyera Sub-County",
    "Ruhaama Sub-County",
    "Rweikiniro Sub-County",
  ],
  "Rushenyi County": [
    "Bwongyera Sub-County",
    "Kayonza Sub-County",
    "Kitwe Sub-County",
    "Nyabisirira Sub-County",
    "Rugarama Sub-County",
  ],
  // Nwoya
  "Nwoya County": [
  ...
  // Rubirizi
  "Bunyaruguru County": [
    "Bunyaruguru Sub-County",
    "Katunguru Sub-County",
    "Kichwamba Sub-County",
    "Magambo Sub-County",
    "Ryeru Sub-County",
    "Rubirizi Sub-County",
  ...
  "Rubabo County": [
    ...
    "Buyanja Sub-County",
    "Kebisoni Sub-County",
    "Nyakagyeme Sub-County",
    "Nyarushanje Sub-County",
  ],
  "Rujumbura County": [
    "Bugangari Sub-County",
    "Buhunga Sub-County",
    "Bwambara Sub-County",
    "Nyakishenyi Sub-County",
    "Rukungiri Municipality",
  ],
  // Rwampara
  "Rwampara County East": [
    "Bugamba Sub-County",
    "Mwizi Sub-County",
    "Ndaija Sub-County",
    "Rwampara Sub-County",
  ],
  "Rwampara County West": [
    "Itojo Sub-County",
    "Kyampangara Sub-County",
    "Ndeija Sub-County",
  ],
  // Sembabule
  "Lwemiyaga County": [
    ...
    "Lwebitakuli Sub-County",
    "Ntuusi Sub-County",
  ],
  "Mawogola County North": [
    "Mateete Sub-County",
    "Mijwala Sub-County",
    "Sembabule Sub-County",
