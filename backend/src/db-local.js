...
db.exec(`
  ...
  CREATE TABLE IF NOT EXISTS screenings (
    ...
    -- VHT Workflow Steps
    equipment_checked INTEGER DEFAULT 0,
    consent_obtained INTEGER DEFAULT 0,
    education_provided INTEGER DEFAULT 0,
    screening_area_prepared INTEGER DEFAULT 0,
    tests_explained_to_client INTEGER DEFAULT 0,
    -- VHT Key Questions
    has_eye_concerns INTEGER,
    follows_movement INTEGER,
    has_severe_eye_pain INTEGER,
    has_sudden_vision_loss INTEGER,
    has_diabetes_hypertension INTEGER,
    family_history_blindness INTEGER,
...
function runMigrations() {
  ...
  const migrations = [
    ...
    { table: "screenings", column: "referral_facility", type: "TEXT" },
    ...
    // Screenings — VHT workflow columns
    { table: "screenings", column: "equipment_checked", type: "INTEGER DEFAULT 0" },
    { table: "screenings", column: "consent_obtained", type: "INTEGER DEFAULT 0" },
    { table: "screenings", column: "education_provided", type: "INTEGER DEFAULT 0" },
    { table: "screenings", column: "screening_area_prepared", type: "INTEGER DEFAULT 0" },
    { table: "screenings", column: "tests_explained_to_client", type: "INTEGER DEFAULT 0" },
    { table: "screenings", column: "has_eye_concerns", type: "INTEGER" },
    { table: "screenings", column: "follows_movement", type: "INTEGER" },
    { table: "screenings", column: "has_severe_eye_pain", type: "INTEGER" },
    { table: "screenings", column: "has_sudden_vision_loss", type: "INTEGER" },
    { table: "screenings", column: "has_diabetes_hypertension", type: "INTEGER" },
    { table: "screenings", column: "family_history_blindness", type: "INTEGER" },
    { table: "screenings", column: "referral_reasons_from_questions", type: "TEXT" },
    { table: "screenings", column: "torch_test_passed", type: "INTEGER" },
    { table: "screenings", column: "torch_test_abnormal_signs", type: "TEXT" },
    // Screenings — glasses columns
    { table: "screenings", column: "glasses_dispensed", type: "INTEGER DEFAULT 0" },
    { table: "screenings", column: "glasses_power", type: "TEXT" },
    { table: "screenings", column: "glasses_frame_type", type: "TEXT" },
    { table: "screenings", column: "glasses_education_provided", type: "INTEGER DEFAULT 0" },
